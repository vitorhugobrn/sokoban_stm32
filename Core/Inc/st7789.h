...
void ST7789_DrawImage_Async(uint16_t x, uint16_t y, uint16_t w, uint16_t h, const uint16_t *data);
void ST7789_DrawImage_Alpha(uint16_t x, uint16_t y, uint16_t w, uint16_t h, const uint16_t *data, uint16_t color_key);

void ST7789_InvertColors(uint8_t invert);

/* DMA status — check before starting a new draw after an _Async call. */
